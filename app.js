...
function applyResponsivePageBackground(){
 ...
 const fallback=isLandscape?'assets/background-landscape.jpg?v=4011':'assets/background-portrait.jpg?v=4011';
...
function init(){
 ...
 $('resetAppearance').onclick=()=>{
  ...
  $('appName').value='GODS OF WAR 371';$('appTitle').textContent='GODS OF WAR 371';document.title='KoW Companion v4.0.11';
